...
public abstract class FluidPipeBlock extends ContainerBlock implements ITileEntityProvider
{
            ...
            Hand hand, BlockRayTraceResult hit)
    {
        ...
        {
            FluidPipeTileEntity tileEntity = (FluidPipeTileEntity) te;
    ...
    public void onRemove(BlockState state, World world, BlockPos blockPos, BlockState newState, boolean isMoving)
    {
        if (state.getBlock() != newState.getBlock())
        {
            ...
            {
                FluidPipeTileEntity pipeTileEntity = (FluidPipeTileEntity) tileEntity;
